...
features:
  - title: Yoozly (v3.x)
    details: Nouvelle API - Arrêts, Lignes, C.Vélo, Itinéraires, News, Events
    link : '/Yoozly/readme'
    icon: |
  ...
  - title: WinDev Push Server (obsolète)
...
La documentation de l'API **Yoozly** (v3.x) est maintenant disponible ! Les anciennes APIs (OpenIT, T2C XML, WinDev, Pegase) sont marquées comme obsolètes.
:::